...
class Portfolio():
    ...
    def __init__(self, account_number: typing.Optional[str]):
    ...
    def add_position(self, symbol: str, asset_type: str, purchase_date:Optional[str], quantity: int = 0, purchase_price: float = 0.0,) -> dict:
        ...
        self.positions[symbol]['purchase_price'] = purchase_date
    ...
    def add_positions(self, positions: List[Dict]) -> dict:
        if isinstance(positions, List):
            for position in positions:
                ...
                raise TypeError("Positions must be a fll list of dictionaries")
    ...
    def is_profitable(self, symbol, current_price: float) -> bool:
    ...
    @property
    def td_client(self) -> client:
        return self._td_client
    @td_client.setter
    def td_client(self, td_client: client) -> None:
        self._td_client: client = td_client
